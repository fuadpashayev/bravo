...
return [
    'max_quota' => env('RV_MEDIA_MAX_QUOTA', 1024 * 1024 * 1024*40),
    ...
    'libraries' => [
        ...
        'javascript' => [
            ...
            'panel/js/pashayev.js?12345',
            'vendor/media/js/media.js?v=' . env('RV_MEDIA_VERSION', time()),
        ],
    ],
    // Allowed mime types
    'allowed_mime_types' => env('RV_MEDIA_ALLOWED_MIME_TYPES', 'jpg,jpeg,png,gif,svg,ico,txt,docx,zip,mp3,bmp,csv,docs,xls,xlsx,ppt,pptx,pdf,mp4'),
    'mime_types' => [
        'image' => [
            'image/png',
            'image/jpeg',
    ...
    'max_file_size_upload' => env('RV_MEDIA_MAX_FILE_SIZE_UPLOAD', 40 * 1024), // Maximum size to upload
