...
(function () {
    ...
    CKEDITOR.config.plugins = 'media,iframe,colorbutton,panelbutton,justify,youtube,font,btquicktable,bt_table,tableresizerowandcolumn,imageresize,imageresizerowandcolumn,imagerotate,wordcount,notification,dialogui,preview,dialog,a11yhelp,basicstyles,blockquote,clipboard,panel,floatpanel,menu,contextmenu,resize,button,toolbar,elementspath,enterkey,entities,popup,filebrowser,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentlist,fakeobjects,link,list,magicline,maximize,pastetext,pastefromword,removeformat,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,undo,wsc,pbckcode,forms';
