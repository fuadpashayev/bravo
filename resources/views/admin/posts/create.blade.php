...
@section('content')
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline py-2">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">{{translate('breadcrumb.newPost')}}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content p-0">
        <form action="{{route('admin.posts.store')}}" method="post" data-reload="{{route('admin.posts.index')}}">
            @csrf
                            ...
                            <div class="tab-pane fade {{getLocale()===$language['key']?'active show':''}}" id="tab-{{$language['key']}}">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <textarea class="form-control post-content" id="content-{{$language['key']}}" name="content[{{$language['key']}}]"></textarea>
