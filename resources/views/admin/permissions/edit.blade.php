...
@section('content')
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline py-2">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">{{$permission['display_name']}}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content p-0">
        <form action="{{route('admin.permissions.update',['permission' => $permission['id']])}}" method="post" data-reload="reload">
            @csrf
            @method('PUT')
            <div class="card border-top-0 mb-0">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div class="input-group">
                                <input class="form-control" id="display_name" name="display_name" value="{{$permission->display_name}}">
                            </div>
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div class="input-group">
                                <input class="form-control" id="description" name="description" value="{{$permission->description}}">
                            </div>
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div class="input-group">
                                <input class="form-control" id="module" name="module" value="{{$permission->module}}">
                            </div>
                ...
                <div class="card-footer">
                    <div class="text-right">
                        <button class="btn bg-slate submitAJAX">{{translate('permissions.editPermission')}}</button>
                    </div>
                </div>
            </div>
        </form>
