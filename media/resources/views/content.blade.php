    ...
    <div class="rv-media-wrapper">
        ...
        <aside class="rv-media-aside @if (config('media.sidebar_display') != 'vertical') rv-media-aside-hide-desktop @endif">
            ...
            <div class="rv-media-block rv-media-filters">
                <ul class="rv-media-aside-list" style="padding: 0 0 10px 0;">
                    <li>
                        <a href="{{route('admin.dashboard')}}">
                            <i class="icon-home4"></i> {{ translate('navigation.dashboard') }}
                        </a>
                    </li>
                </ul>
                <div class="rv-media-block-title">
                    {{ translate('media.filter') }}
                </div>
                    ...
                    <ul class="rv-media-aside-list">
                        <li>
                            <a href="#" class="js-rv-media-change-filter" data-type="filter" data-value="everything">
                                <i class="fa fa-recycle"></i> {{ translate('media.everything') }}
                            </a>
                        </li>
                        @if (array_key_exists('image', config('media.mime_types', [])))
                            <li>
                                <a href="#" class="js-rv-media-change-filter" data-type="filter" data-value="image">
                                    <i class="fa fa-file-image-o"></i> {{ translate('media.image') }}
                                </a>
                            </li>
                        @endif
                        @if (array_key_exists('video', config('media.mime_types', [])))
                            <li>
                                <a href="#" class="js-rv-media-change-filter" data-type="filter" data-value="video">
                                    <i class="fa fa-file-video-o"></i> {{ translate('media.video') }}
                                </a>
                            </li>
                        @endif
                        <li>
                            <a href="#" class="js-rv-media-change-filter" data-type="filter" data-value="document">
                                <i class="fa fa-file-o"></i> {{ translate('media.document') }}
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="rv-media-aside-list">
                        ...
                        @if (RvMedia::hasAnyPermission(['folders.delete', 'files.delete']))
                            <li>
                                <a href="#" class="js-rv-media-change-filter" data-type="view_in" data-value="trash">
                                    <i class="fa fa-trash"></i> {{ translate('media.trash') }}
                                </a>
                            </li>
                        @endif
                        <li>
                            <a href="#" class="js-rv-media-change-filter" data-type="view_in" data-value="recent">
                                <i class="fa fa-clock-o"></i> {{ translate('media.recent') }}
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="#" class="js-rv-media-change-filter" data-type="view_in" data-value="favorites">
                                <i class="fa fa-star"></i> {{ translate('media.favorites') }}
                            </a>
                        </li>
                        @endif
                    </ul>
                ...
                <div class="rv-media-top-header">
                    <div class="rv-media-actions">
                        ...
                        @if (RvMedia::hasPermission('files.create'))
                            <button class="btn btn-success js-dropzone-upload">
                                <i class="fa fa-cloud-upload"></i> {{ translate('media.upload') }}
                            </button>
                        @endif
                            ...
                            <div class="btn-group" role="group">
                                <div class="dropdown">
                                    <button class="btn btn-success dropdown-toggle" type="button" data-toggle="dropdown">
                                        <i class="fa fa-plus"></i> {{ translate('media.add_from') }}
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="#" data-toggle="modal" data-target="#modal_add_from_youtube">
                                                <i class="fa fa-youtube"></i> {{ translate('media.youtube') }}
                                            </a>
                                        </li>
                                        @if (app()->environment() == 'demo')
                                            <li>
                                                <a href="#" data-toggle="modal" data-target="#modal_coming_soon">
                                                    <i class="fa fa-vimeo"></i> {{ translate('media.vimeo') }}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-toggle="modal" data-target="#modal_coming_soon">
                                                    <i class="fa fa-vine"></i> {{ translate('media.vine') }}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-toggle="modal" data-target="#modal_coming_soon">
                                                    <i class="fa fa-youtube-play"></i> {{ translate('media.daily_motion') }}
                                                </a>
                                            </li>
                                        @endif
                                    </ul>
                        ...
                        @if (RvMedia::hasPermission('folders.create'))
                            <button type="button" class="btn btn-success" data-toggle="modal" data-backdrop="false" data-target="#modal_add_folder">
                                <i class="fa fa-folder"></i> {{ translate('media.create_folder') }}
                            </button>
                        @endif
                        <button class="btn btn-success js-change-action" data-type="refresh">
                            <i class="fa fa-refresh"></i> {{ translate('media.refresh') }}
                        </button>
                        ...
                        @if (config('media.sidebar_display') != 'vertical')
                            <div class="btn-group" role="group">
                                <div class="dropdown">
                                    <button class="btn btn-success dropdown-toggle js-rv-media-change-filter-group" type="button" data-toggle="dropdown">
                                        <i class="fa fa-filter"></i> {{ translate('media.filter') }} <span class="js-rv-media-filter-current"></span>
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="#" class="js-rv-media-change-filter" data-type="filter" data-value="everything">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-success dropdown-toggle js-rv-media-change-filter-group" type="button" data-toggle="dropdown">
                                    <i class="fa fa-eye"></i> {{ translate('media.view_in') }} <span class="js-rv-media-filter-current"></span>
                                </button>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="#" class="js-rv-media-change-filter" data-type="view_in" data-value="all_media">
                        ...
                        @if (RvMedia::hasAnyPermission(['folders.delete', 'files.delete']))
                            <button class="btn btn-danger js-files-action hidden" data-action="empty_trash">
                                <i class="fa fa-trash-o"></i> {{ translate('media.empty_trash') }}
                            </button>
                        @endif
                    ...
                    <div class="rv-media-search">
                        <form class="input-search-wrapper" action="" method="GET">
                            <input type="text" class="form-control" placeholder="{{ translate('media.search_file_and_folder') }}">
                        ...
                        <div class="btn-group" role="group">
                            <div class="dropdown">
                                <button class="btn btn-default dropdown-toggle"
                                    ...
                                    {{ translate('media.sort') }} <i class="fa fa-sort-alpha-desc"></i>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a href="#"
                                           ...
                                           data-type="sort_by"
                                           data-value="name-asc">
                                            <i class="fa fa-sort-alpha-asc"></i> {{ translate('media.file_name_asc') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="name-desc">
                                            <i class="fa fa-sort-alpha-desc"></i> {{ translate('media.file_name_desc') }}
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="created_at-asc">
                                            <i class="fa fa-sort-numeric-asc"></i> {{ translate('media.created_date_asc') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="created_at-desc">
                                            <i class="fa fa-sort-numeric-desc"></i> {{ translate('media.created_date_desc') }}
                                        </a>
                                    </li>
                                    <li role="separator" class="divider"></li>
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="updated_at-asc">
                                            <i class="fa fa-sort-numeric-asc"></i> {{ translate('media.uploaded_date_asc') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="updated_at-desc">
                                            <i class="fa fa-sort-numeric-desc"></i> {{ translate('media.uploaded_date_desc') }}
                                        </a>
                                    </li>
                                    <li role="separator" class="divider"></li>
                                    <li>
                                        <a href="#"
                                           ...
                                           data-type="sort_by"
                                           data-value="size-asc">
                                            <i class="fa fa-sort-numeric-asc"></i> {{ translate('media.size_asc') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#"
                                           ...
                                           data-value="size-desc">
                                            <i class="fa fa-sort-numeric-desc"></i> {{ translate('media.size_desc') }}
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            <div class="dropdown rv-dropdown-actions disabled">
                                <button class="btn btn-default dropdown-toggle"
                                    ...
                                    {{ translate('media.actions') }} &nbsp;<i class="fa fa-ellipsis-v"></i>
                                </button>
                ...
                <div class="rv-media-details hidden">
                    ...
                    <div class="rv-media-description">
                        <div class="rv-media-name">
                            <p>{{ translate('media.nothing_is_selected') }}</p>
                        </div>
                    </div>
                </div>
            </main>
            <footer class="rv-media-footer hidden">
                <button type="button" class="btn btn-danger btn-lg js-insert-to-editor">{{ translate('media.insert') }}</button>
            </footer>
        </div>
        <div class="rv-upload-progress hide-the-pane">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">{{ translate('media.upload_progress') }}</h3>
    ...
    <div class="rv-modals">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss-modal="#modal_coming_soon" aria-label="{{ translate('media.close') }}">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        <h4 class="modal-title">
                            <i class="fa fa-windows"></i> {{ translate('media.coming_soon') }}
                        </h4>
                    </div>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modal_add_from_youtube">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss-modal="#modal_add_from_youtube" aria-label="{{ translate('media.close') }}">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        <h4 class="modal-title">
                            <i class="fa fa-windows"></i> {{ translate('media.add_from_youtube') }}
                        </h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="input-group">
                                <label class="input-group-addon custom-checkbox">
                                    ...
                                    <small>{{ translate('media.playlist') }}</small>
                                </label>
                                <input type="text" class="form-control rv-youtube-url" placeholder="https://">
                                <div class="input-group-btn">
                                    <button class="btn btn-success rv-btn-add-youtube-url" type="button">{{ translate('media.add_url') }}
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modal_add_folder">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss-modal="#modal_add_folder" aria-label="{{ translate('media.close') }}">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        <h4 class="modal-title">
                            <i class="fa fa-windows"></i> {{ translate('media.create_folder') }}
                        </h4>
                    </div>
                    <div class="modal-body">
                        <form class="rv-form form-add-folder">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="{{ translate('media.folder_name') }}">
                                <div class="input-group-btn">
                                    <button class="btn btn-success rv-btn-add-folder" type="submit">{{ translate('media.create') }}</button>
                                </div>
                            </div>
                        </form>
                        <div class="modal-notice"></div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form class="rv-form form-rename">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss-modal="#modal_rename_items" aria-label="{{ translate('media.close') }}">
                                <span aria-hidden="true">&times;</span>
                            </button>
                            <h4 class="modal-title">
                                <i class="fa fa-windows"></i> {{ translate('media.rename') }}
                            </h4>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss-modal="#modal_rename_items">{{ translate('media.close') }}</button>
                            <button type="submit" class="btn btn-primary">{{ translate('media.save_changes') }}</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-danger" role="document">
                <div class="modal-content">
                    <form class="rv-form form-delete-items">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss-modal="#modal_trash_items" aria-label="{{ translate('media.close') }}">
                                <span aria-hidden="true">&times;</span>
                            </button>
                            <h4 class="modal-title">
                                <i class="fa fa-windows"></i> {{ translate('media.move_to_trash') }}
                            </h4>
                        </div>
                        <div class="modal-body">
                            <p>{{ translate('media.confirm_trash') }}</p>
                            <div class="modal-notice"></div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-danger">{{ translate('media.confirm') }}</button>
                            <button type="button" class="btn btn-primary" data-dismiss-modal="#modal_trash_items">{{ translate('media.close') }}</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modal_delete_items">
            <div class="modal-dialog modal-danger" role="document">
                <div class="modal-content">
                    <form class="rv-form form-delete-items">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss-modal="#modal_delete_items" aria-label="{{ translate('media.close') }}">
                                <span aria-hidden="true">&times;</span>
                            </button>
                            <h4 class="modal-title">
                                <i class="fa fa-windows"></i> {{ translate('media.confirm_delete') }}
                            </h4>
                        </div>
                        <div class="modal-body">
                            <p>{{ translate('media.confirm_delete_description') }}</p>
                            <div class="modal-notice"></div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-danger">{{ translate('media.confirm') }}</button>
                            <button type="button" class="btn btn-primary" data-dismiss-modal="#modal_delete_items">{{ translate('media.close') }}</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-danger" role="document">
                <div class="modal-content">
                    <form class="rv-form form-empty-trash">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss-modal="#modal_empty_trash" aria-label="{{ translate('media.close') }}">
                                <span aria-hidden="true">&times;</span>
                            </button>
                            <h4 class="modal-title">
                                <i class="fa fa-windows"></i> {{ translate('media.empty_trash_title') }}
                            </h4>
                        </div>
                        <div class="modal-body">
                            <p>{{ translate('media.empty_trash_description') }}</p>
                            <div class="modal-notice"></div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-danger">{{ translate('media.confirm') }}</button>
                            <button type="button" class="btn btn-primary" data-dismiss-modal="#modal_empty_trash">{{ translate('media.close') }}</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/x-custom-template" id="rv_media_items_list">
    <div class="rv-media-list">
        <ul>
            ...
            <li class="rv-media-list-title up-one-level js-up-one-level" title="{{ translate('media.up_level') }}">
    ...
    <div class="rv-media-grid">
        <ul>
            ...
            <li class="rv-media-list-title up-one-level js-up-one-level">
                <div class="rv-media-item" data-context="__type__" title="{{ translate('media.up_level') }}">
                    <div class="rv-media-thumbnail">
                        <i class="fa fa-level-up"></i>
                    </div>
                    <div class="rv-media-description">
