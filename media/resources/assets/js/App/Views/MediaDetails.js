    ...
    renderData(data) {
        ...
        if (useClipboard) {
            ...
            $('.js-btn-copy-to-clipboard').tooltip()
                .on('mouseenter', function () { $(this).tooltip('hide'); })
